...
All models are quantised to `FP16`.<br>
...
- Use an `onnx` model from the `./models` folder.<br>
  ...
  * YoloV8n.onnx
  * YoloV8s.onnx
- Download an `onnx` model from our server.<br>
  * [YoloV8n.onnx](https://storage.qengineering.eu/Onnx%20models/yolov8n.onnx)
  * [YoloV8s.onnx](https://storage.qengineering.eu/Onnx%20models/yolov8s.onnx)
  * [YoloV8m.onnx](https://storage.qengineering.eu/Onnx%20models/yolov8m.onnx)
  * [YoloV8l.onnx](https://storage.qengineering.eu/Onnx%20models/yolov8l.onnx)
  * [YoloV8x.onnx](https://storage.qengineering.eu/Onnx%20models/yolov8x.onnx)
...
You could include this folder in your PATH with the following command.<br>
```script
